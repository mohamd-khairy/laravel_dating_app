                        ...
                        <ul  class="col-lg-12">
                             ...
                             <?php 
                                ...
                                foreach ($data as $key => $value) {
                                 ...
                                 $like=App\Like::where('like_user_id',Auth::user()->id)->where('user_id',$value->user_id)->first();
                                    if(!isset($like)){
                                        continue;
                                    }
                            ...
                            <li class=" col-lg-2 col-md-6 col-sm-12 col-xs-12 p-b-20 p-t-20" >
                                ...
                                <div class="block2-overlay trans-0-4">
                                        <div  class="block2-btn-addcart w-size1 trans-0-4">
                                            <!-- Button -->
                                            <a style="color:white" href="#"  class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 ">
                                               Send Message
                                            </a>
...
<script>
    window.onload = function () {
        $("#likee2").attr('style', 'color:orange');
