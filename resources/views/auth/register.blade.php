                ...
                <div   class="flex-w flex-sb bo10 p-t-15 p-b-20">
                    ...
                    <div class="w-size20 w-full-sm">
                        <p class="s-text8 p-b-23" style="color: black">
                            Please Input your Correct Email, contact us if you need any help.
                        </p>

                        <div class="size13 bo4 m-b-22 form-group{{ $errors->has('name') ? ' has-error' : '' }}">

                                <input id="name" type="text" class="sizefull s-text7 p-l-15 p-r-15"  name="name" placeholder="Name">
                        ...
                        <div class="size13 bo4 m-b-22 form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <input id="email" type="email" class="sizefull s-text7 p-l-15 p-r-15" name="email"  placeholder="Email">
                       ...
                       <div class="size13 bo4 m-b-22">
                                <input id="confirm_password" type="password" class="sizefull s-text7 p-l-15 p-r-15" name="confirm_password" placeholder="Confirm Password">
